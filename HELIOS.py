...
def ZPos(v, thetalab, charge, mass, B, arrayradius = 0.03):
...
def OrbitProperty(v, thetalab,charge, mass, B):
    Pcharge = charge
    Pmass_tmp = mass
    Pmass = Pmass_tmp/math.sqrt(1-v*v/(__constant_c*__constant_c))
    ...
    OrbitRadius = Pmass * Vpr/(Pcharge*B)
    OrbitTime =  2*math.pi*Pmass/(Pcharge*B)
    #print "11:",thetalab,v,Vpr, Pcharge,mass,Pcharge,B,OrbitRadius
    return OrbitRadius, OrbitTime
